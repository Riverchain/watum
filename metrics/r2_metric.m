function r2 = r2_metric (observed, forecasted)
% R2 or Rsqr is a metric for evaluating numerical model performance.
%   is used to calculate the ’’coefficient of determination’’
% which is the square of the ’’Pearson product moment correlation
% coefficient’’ (RSqr; Pearson, 1896). This metric
% comprises the squared ratio of the combined dispersion of two series to 
% the total dispersion of the observed and modelled
